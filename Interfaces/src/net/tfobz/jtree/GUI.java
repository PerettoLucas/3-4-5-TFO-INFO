...
public class GUI extends JFrame
{
	...
	public GUI()
	{
		...
		//DefaultMutableTreeNode erm�glicht es Dynamisch "Kinder hinzuzuf�gen"
		wurzel = new DefaultMutableTreeNode("unsichtbare Wurzel");
		wurzel.add(new Addition());
	
		
		//Renderer setzt die Icons der Baum�ste
		...
		//SetEditable true damit mann den inhalt ver�ndern kann
